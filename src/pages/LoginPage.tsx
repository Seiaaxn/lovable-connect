      ...
      <div className="flex items-center justify-center min-h-[70vh] px-4">
        <div className="w-full max-w-sm space-y-6">
          <div className="text-center space-y-2">
            <h1 className="text-2xl font-display font-bold text-foreground">Masuk</h1>
            <p className="text-sm text-muted-foreground">Masuk untuk menyimpan favorit dan riwayat</p>
          </div>
          <button
